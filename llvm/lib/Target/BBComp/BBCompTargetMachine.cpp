//===-- BBCompTargetMachine.cpp - Define TargetMachine for BBComp ---------===//
//
...
//===----------------------------------------------------------------------===//
//
// This file defines the BBComp specific subclass of TargetMachine.
//
//===----------------------------------------------------------------------===//

#include "BBCompTargetMachine.h"
#include "TargetInfo/BBCompTargetInfo.h"
...
extern "C" void LLVMInitializeBBCompTarget() {
  RegisterTargetMachine<BBCompTargetMachine> X(getTheBBCompTarget());
}
...
BBCompTargetMachine::BBCompTargetMachine(
